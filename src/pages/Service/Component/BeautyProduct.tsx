...
function BeautyProduct() {
  return (
    <div tw='relative'>
      <Section tw='xl:mt-[9.2rem] md:mt-[7.55rem] xs:mt-[6rem]'>
        <Wrapper>
          <Row tw='md:flex-row-reverse justify-between gap-y-28'>
            <Column tw='md:items-start xs:items-center  basis-[41.8%] gap-y-[0.3rem]'>
              <TitleHeading tw='md:text-left'>Beauty Product</TitleHeading>
            ...
            <Column tw='basis-[42.7%] justify-center items-center relative '>
              <ImageSrc
                src='/service/Vector-3.png'
                clx='absolute top-[50%] left-[50%] translate-x-[-55.5%] translate-y-[-50.5%] w-[62.5%] -z-10'
              />
              <ImageSrc
                clx='md:w-[60.8%] xs:w-[60%] mt-[0.1rem] h-auto object-cover xl:mr-[0.3rem]'
                src='/service/animation-2.png'
                alt=''
              />
            </Column>
          </Row>
