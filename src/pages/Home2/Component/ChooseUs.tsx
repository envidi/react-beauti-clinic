...
const Achievement = tw.div`flex items-center xs:justify-center md:justify-start  w-full md:text-left text-center`;
const AchievementNumber = tw.div`text-background-main text-[2.2rem] tracking-[0.06rem] font-semibold leading-3 md:text-left text-center`;
    ...
    >
      <Wrapper tw='flex items-center md:flex-row xs:flex-col xs:justify-center'>
        <div tw='md:basis-1/2 xs:w-full flex flex-col xs:items-center md:items-start gap-y-[1rem] md:ml-[0.4rem] mt-[0.9rem]'>
          <h3 tw='text-[2.21rem] tracking-[0.025rem] md:text-left xs:text-center font-semibold text-background-main'>
            Why choosing us?
          </h3>
        ...
        <Achievements tw='grid grid-cols-2 md:basis-1/2 basis-4/12 xs:justify-items-center items-center md:ml-[7.2rem] md:gap-y-[2.2rem] xs:gap-y-[0.2rem] gap-x-[1.7rem] md:mt-[1.2rem] xs:mt-[0.5rem]'>
          <Achievement>
            <div tw='md:basis-[26.5%] xs:basis-[30%]'>
              <ImageSrc clx='w-full object-cover' src='/handshake.png' />
            </div>
            <div tw='flex flex-col md:basis-2/3 xs:basis-[57%] justify-start md:ml-[0.6rem] gap-y-[1.05rem] mt-[0.6rem]'>
          ...
          <Achievement>
            ...
            <div tw='flex flex-col md:basis-2/3 xs:basis-[57%] justify-start md:ml-[0.6rem] gap-y-[1.05rem] mt-[1.2rem]'>
